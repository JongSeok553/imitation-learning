...
flags.DEFINE_string('output_dir', default='home/ljs/imitation-learning/imitation/data/imitation_learning/experiments/2proposed_test',
...
def train_input_fn():
    ...
    train_files = inputs.get_tfrecord_paths(os.getcwd()+FLAGS.train_path)
...
def eval_validation_input_fn():
    ...
    val_files = inputs.get_tfrecord_paths(os.getcwd()+FLAGS.validation_path)
...
def eval_train_input_fn():
    ...
    train_val_files = inputs.get_tfrecord_paths(os.getcwd()+FLAGS.train_path)
    return input_fn.evaluation_input_fn(
...
def get_model_dir():
    ...
    """
    return os.path.join(os.getcwd()+FLAGS.output_dir, 'train')
